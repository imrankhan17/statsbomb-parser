...
def test_parser():
    ...
    assert lineup.get_dataframe().to_dict(orient='records') == [
        ...
        {'country': 'United States of America', 'jersey_number': 15, 'player_id': 5047, 'player_name': 'Jaelene Hinkle',
         'team_id': 766, 'team_name': 'North Carolina Courage'},
        {'country': 'United States of America', 'jersey_number': 0, 'player_id': 5048, 'player_name': 'Katelyn Rowland',
         'team_id': 766, 'team_name': 'North Carolina Courage'},
        {'country': 'United States of America', 'jersey_number': 25, 'player_id': 5050, 'player_name': 'Meredith Speck',
         'team_id': 766, 'team_name': 'North Carolina Courage'},
        ...
        {'country': 'United States of America', 'jersey_number': 6, 'player_id': 5063, 'player_name': 'Chioma Ubogagu',
         'team_id': 764, 'team_name': 'Orlando Pride'},
        {'country': 'United States of America', 'jersey_number': 16, 'player_id': 5064, 'player_name': 'Carson Pickett',
         'team_id': 764, 'team_name': 'Orlando Pride'},
        ...
        {'country': 'United States of America', 'jersey_number': 7, 'player_id': 5070, 'player_name': 'Christine Nairn',
         'team_id': 764, 'team_name': 'Orlando Pride'},
